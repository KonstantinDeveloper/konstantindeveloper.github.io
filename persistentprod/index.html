...
<html>
	<head>
		<title>Persistent Prod</title>
		<meta charset="utf-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<link href="images/ppico.png" rel="shortcut icon" type="image/x-icon">
		...
		<div id="page-wrapper">
			...
			<!-- Banner -->
				<section id="banner">
					<div class="content">
						<header>
							<h2>Не большая команда разработчиков</h2>
							<p>Мы создали Survaved Online и Five Night`s a Fedorovich<br />
...
-->
			<!-- Footer -->
				<footer id="footer">
					<ul class="icons">
						<li><a href="https://youtube.com/@persistentprod9013" class="icon alt fa-youtube"><span class="label">YouTube</span></a></li>
						<li><a href="https://sites.google.com/view/persistentprodsite/" class="icon alt fa-google"><span class="label">2 Сайт</span></a></li>
				         	<li><a href="https://discord.gg/2Hp26nE26P" class="icon alt fa-discord"><span class="label">Discord</span></a></li>
					</ul>
					<ul class="copyright">
						<li>&copy; Persistent Prod, All rights reserved.</li><li>Работает с 18.10.2024.</li>
					</ul>
				</footer>
